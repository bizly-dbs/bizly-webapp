    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-4 font-['Poppins']">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 text-center mb-2">Masuk</h1>
          <p className="text-center text-gray-600 mb-8">Masukkan email dan kata sandi Anda untuk masuk!</p>
