        ...
        <div className="p-6">
            ...
            <form onSubmit={handleSubmitEmail}>
              <div className="mb-8 text-center">
                <div className="flex justify-center mb-4">
                  <MailOutlineIcon sx={{ fontSize: 48 }} className="text-blue-600" />
                </div>
            ...
            <form onSubmit={handleVerifyOtp}>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-center text-gray-500">
                  Tidak menerima kode? <button type="button" className="text-blue-600 font-medium">Kirim Ulang</button>
                </p>
              </div>
          ...
          {step === 3 && (
            <form onSubmit={handleResetPassword}>
              ...
              <button
                type="submit"
                className={`w-full py-3 rounded-lg font-medium text-white ${
                  loading || (newPassword !== confirmPassword) ? 'bg-blue-500' : 'bg-blue-600 hover:bg-blue-700'
                }`}
          ...
          {step === 4 && (
            <div className="text-center py-8">
              <div className="flex justify-center mb-4">
                <CheckCircleOutlineIcon sx={{ fontSize: 64 }} className="text-blue-600" />
              </div>
